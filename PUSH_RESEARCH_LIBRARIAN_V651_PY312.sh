...
RELEASE_VERSION="6.5.1"
RELEASE_TAG="v${RELEASE_VERSION}"
SCRIPT_REVISION="v651-py312-accessibility-performance-r1"
REPO_URL="git@github.com:Content-Catalyst-LLC/sustainable-catalyst-research-librarian-ai.git"
ZIP_PATH="${1:-$HOME/Downloads/sustainable-catalyst-research-librarian-ai-v6.5.1.zip}"
REPO_DIR="${2:-$HOME/Downloads/sustainable-catalyst-research-librarian-ai-repo-v651-clean}"
...
TMP_DIR="$(mktemp -d "${TMPDIR:-/tmp}/sc-rl-v651.XXXXXX")"
...
grep -q 'Version: 6.5.1' "$SOURCE_DIR/sustainable-catalyst-research-librarian-ai.php" || fail "The package version marker is not 6.5.1."
grep -q 'data-workspace-version="1.1"' "$SOURCE_DIR/sustainable-catalyst-research-librarian-ai.php" || fail "The public workspace marker is missing."
...
grep -q 'sc-research-librarian-public-workspace/1.1' "$SOURCE_DIR/backend/app/main.py" || fail "The public workspace response schema is missing."
...
git tag -a "$RELEASE_TAG" -m "Research Librarian v${RELEASE_VERSION} — Accessibility, Performance, and Interface Reliability"
