...
ComponentType = Literal[
    ...
    "cross-product-exchange", "research-question-plan", "research-design-plan", "evidence-search-strategy-plan", "systematic-review-plan", "literature-intelligence-plan", "core-object",
]
