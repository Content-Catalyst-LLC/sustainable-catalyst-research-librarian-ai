...
class KnowledgeStore:
    ...
    def connected_platform_summary(self) -> dict[str, Any]:
        ...
        return {"schema":"sc-connected-research-platform-summary/1.0","version":"7.0.3","counts":counts,"workspace_schema":"sc-research-librarian-public-workspace/2.0","api_schema":"sc-connected-research-api/1.0"}
