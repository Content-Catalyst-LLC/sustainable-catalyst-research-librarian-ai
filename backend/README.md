...
The free Render filesystem is ephemeral. The WordPress plugin therefore includes a complete resynchronization action and scheduled incremental synchronization. A paid persistent disk is optional, not required for initial operation.
