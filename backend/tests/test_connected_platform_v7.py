...
def test_stable_api_manifest_and_summary():
    ...
    body=api.json()
    assert body['schema']=='sc-connected-research-api/1.1'
    ...
    assert summary['version']=='7.2.0'
    assert summary['workspace_schema']=='sc-research-librarian-public-workspace/2.1'
