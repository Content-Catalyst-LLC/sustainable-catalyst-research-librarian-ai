...
- Added non-executing handoffs for Workspace, Research Lab, Workbench, language runtimes, and Platform Core candidates.
- Added migration 024, authenticated APIs, durable snapshot jobs, immutable snapshots, and unified-environment bindings.
- Preserved human method/runtime approval and specialist-runtime execution boundaries.
