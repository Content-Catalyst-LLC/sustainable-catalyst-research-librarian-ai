<?php
/**
 * Research Librarian AI v7.0.2 — Connected Research Intelligence Platform.
 */
...
final class SC_RL6_V700_Connected_Platform {
    ...
    public static function render_admin() {
        ...
        <div class="wrap"><h1>Connected Research Intelligence Platform</h1><p>v7.0.2 consolidates verified retrieval, persistent projects, investigations, evidence, workflows, cross-product handoffs, artifact history, governance, and portable recovery into one human-controlled research environment.</p>
