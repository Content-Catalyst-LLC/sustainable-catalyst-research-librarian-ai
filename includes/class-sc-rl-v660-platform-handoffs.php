<?php
/**
 * Research Librarian AI v7.4.0 — Cross-Product Reliability and Research Context Handoffs.
 */
...
final class SC_RL6_V660_Platform_Handoffs {
    ...
    public static function render_admin_page() {
        ...
        <div class="wrap">
            ...
            <p>v7.4.0 preserves versioned research handoffs with compatibility checks, bounded retries, token recovery, idempotency, receipts, and immutable artifact returns for Workbench, Decision Studio, Site Intelligence, Lab, and Feature Suggestions. Disabling a destination removes it from public actions and handoff preparation.</p>
            <form method="post">
