<?php
/**
 * Research Librarian AI v6.6.1 — Cross-Product Reliability Patch.
 */
...
final class SC_RL6_V660_Platform_Handoffs {
    ...
    public static function render_admin_page() {
        ...
        <div class="wrap">
            ...
            <p>v6.6.1 hardens versioned research handoffs with compatibility checks, bounded retries, token recovery, idempotency, receipts, and immutable artifact returns for Workbench, Decision Studio, Site Intelligence, Lab, and Feature Suggestions. Disabling a destination removes it from public actions and handoff preparation.</p>
            <form method="post">
