<?php
/**
 * Research Librarian AI v6.6.0 — consolidated administration and Python intelligence operations.
 */
...
final class SC_RL6_V610_Live_AI_Admin {
    ...
    public static function render_dashboard() {
        ...
        <div class="wrap">
            ...
            <?php elseif ( 'authorization' === $gemini_key_type ) : ?>
                <div class="notice notice-info"><p><strong>Gemini authorization key detected.</strong> Research Librarian AI v6.6.0 retains support for modern Google AI Studio authorization keys, including keys that contain periods.</p></div>
            <?php endif; ?>
    ...
    public static function render_provider_page() {
        ...
        <div class="wrap">
            ...
            <p><?php esc_html_e( 'Optional fallback provider configuration for direct WordPress operation when the Python/Render service is disabled. The primary v6.6.0 architecture is configured under Python Intelligence.', 'sustainable-catalyst-research-librarian-ai' ); ?></p>
