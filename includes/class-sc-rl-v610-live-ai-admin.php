<?php
/**
 * Research Librarian AI v7.0.6 — consolidated administration and Python intelligence operations.
 */
    ...
    public static function render_dashboard() {
        ...
        <div class="wrap">
            ...
            <?php elseif ( 'authorization' === $gemini_key_type ) : ?>
                <div class="notice notice-info"><p><strong>Gemini authorization key detected.</strong> Research Librarian AI v7.0.6 retains support for modern Google AI Studio authorization keys, including keys that contain periods.</p></div>
            <?php endif; ?>
