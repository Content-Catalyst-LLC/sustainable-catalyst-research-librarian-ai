<?php
/**
 * Research Librarian AI v8.0.0 — Library Context Alignment with Durable Recovery.
 */
    ...
    public static function render_admin_page() {
        ...
        <div class="wrap sc-rl-v702-admin">
            ...
            <section class="sc-rl-v702-hero" data-state="<?php echo esc_attr( $primary_state ); ?>">
                <div>
                    <div class="sc-rl-v702-eyebrow">Research Librarian v8.0.0</div>
            ...
            <?php if ( $build_state ) : ?>
                <section class="sc-rl-v703-job" aria-live="polite">
                    ...
                    <?php if ( 'postgres' !== $database_backend ) : ?><div class="sc-rl-v703-cron"><strong>SQLite fallback mode.</strong> Local development may still use <code>SC_RL_DATA_DIR=/var/data/sc-research-librarian</code>, but production v8.0.0 requires verified Neon Postgres.</div><?php endif; ?>
