# Research Librarian v4.7.1 — Guided Research Paths and Multi-Step Route Builder

v4.7.1 adds a guided-path layer on top of the Research Librarian routing, retrieval, handoff, and governance stack.
...
This rebuild restores and preserves the v4.6.0 public answer UX layer while adding guided research paths and the multi-step route builder. It includes source cards, confidence badges, the Route Action Center, answer UX endpoints, and guided path endpoints in the same release package.
