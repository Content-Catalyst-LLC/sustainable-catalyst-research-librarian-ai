<?php
/** Static release contract for v7.1.1 transaction-state reconciliation and durable recovery. */
...
$checks = array(
    ...
    'manifest' => is_array( $manifest ) && '7.1.1' === ( $manifest['version'] ?? '' ) && 12 === ( $manifest['sqlite_schema'] ?? 0 ),
);
