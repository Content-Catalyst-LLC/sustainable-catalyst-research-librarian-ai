...
$checks=array(
 ...
 'sqlite_18'=>false!==strpos($store,'SCHEMA_VERSION = 18'),
 'knowledge_index_13'=>false!==strpos($store,'sc-research-librarian-knowledge-index/13.0'),
 'no_postgres_migration'=>3===count($migrations),
 ...
 'readme_v8'=>false!==strpos($readme,'# Sustainable Catalyst Research Librarian AI v8.0.0'),
);
