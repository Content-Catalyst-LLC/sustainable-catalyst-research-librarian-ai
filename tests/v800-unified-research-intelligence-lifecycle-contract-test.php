...
$checks=array(
 ...
 'no_postgres_migration'=>4===count($migrations) && is_file($root.'/backend/migrations/004_async_document_processing_runtime.sql'),
 ...
 'readme_v8'=>false!==strpos($readme,'# Sustainable Catalyst Research Librarian AI v8.4.0'),
);
