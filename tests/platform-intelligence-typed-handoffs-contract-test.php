...
$checks = array(
    ...
    'bridge_version' => false !== strpos( $bridge, "const VERSION = '7.2.0';" ),
    'durable_module_version' => false !== strpos( $module, "const VERSION = '7.2.0';" ),
    ...
    'workspace_schema' => false !== strpos( $backend, 'sc-research-librarian-public-workspace/2.1' ),
    ...
    'render_release_version' => false !== strpos( $render, 'SC_RL_RELEASE_VERSION' ) && false !== strpos( $render, '7.2.0' ),
