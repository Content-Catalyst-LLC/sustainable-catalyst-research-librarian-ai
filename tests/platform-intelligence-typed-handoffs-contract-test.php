<?php
/** Static release contract checks for Research Librarian AI v7.1.2 compatibility regression. */
...
$checks = array(
    'version_header' => false !== strpos( $main, 'Version: 10.8.0' ),
    'version_constant' => false !== strpos( $main, "const VERSION        = '10.8.0';" ),
    'bridge_version' => false !== strpos( $bridge, "const VERSION = '8.0.0';" ),
    'durable_module_version' => false !== strpos( $module, "const VERSION = '8.0.0';" ),
    'backend_version' => false !== strpos( file_get_contents( $root . '/backend/app/__init__.py' ), '__version__ = "10.8.0"' ),
    ...
    'workspace_schema' => false !== strpos( $backend, 'sc-research-librarian-public-workspace/3.0' ),
    ...
    'route_note_handoff' => false !== strpos( $module, "'handoff_payload'" ) && false !== strpos( $module, 'sc-research-librarian-route-note/7.1.2' ),
    ...
    'render_release_version' => false !== strpos( $render, 'SC_RL_RELEASE_VERSION' ) && false !== strpos( $render, '10.8.0' ),
