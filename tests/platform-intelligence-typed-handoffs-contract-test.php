...
$checks = array(
    ...
    'durable_module_version' => false !== strpos( $module, "const VERSION = '7.1.2';" ),
    ...
    'render_release_version' => false !== strpos( $render, 'SC_RL_RELEASE_VERSION' ) && false !== strpos( $render, '7.1.2' ),
