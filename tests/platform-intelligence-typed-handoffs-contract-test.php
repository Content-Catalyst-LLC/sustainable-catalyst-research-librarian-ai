...
$checks = array(
    ...
    'backend_version' => false !== strpos( file_get_contents( $root . '/backend/app/__init__.py' ), '__version__ = "8.10.0"' ),
    ...
    'render_release_version' => false !== strpos( $render, 'SC_RL_RELEASE_VERSION' ) && false !== strpos( $render, '8.10.0' ),
