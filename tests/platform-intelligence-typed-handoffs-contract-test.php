...
$checks = array(
    ...
    'bridge_version' => false !== strpos( $bridge, "const VERSION = '7.6.0';" ),
    'durable_module_version' => false !== strpos( $module, "const VERSION = '7.6.0';" ),
    'backend_version' => false !== strpos( file_get_contents( $root . '/backend/app/__init__.py' ), '__version__ = "7.6.0"' ),
    'sqlite_schema_seven' => false !== strpos( $store, 'SCHEMA_VERSION = 16' ),
    ...
    'render_release_version' => false !== strpos( $render, 'SC_RL_RELEASE_VERSION' ) && false !== strpos( $render, '7.6.0' ),
