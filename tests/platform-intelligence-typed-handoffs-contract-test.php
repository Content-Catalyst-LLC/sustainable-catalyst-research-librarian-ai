...
$checks = array(
    'version_header' => false !== strpos( $main, 'Version: 8.7.0' ),
    'version_constant' => false !== strpos( $main, "const VERSION        = '8.7.0';" ),
    'bridge_version' => false !== strpos( $bridge, "const VERSION = '8.0.0';" ),
    'durable_module_version' => false !== strpos( $module, "const VERSION = '8.0.0';" ),
    'backend_version' => false !== strpos( file_get_contents( $root . '/backend/app/__init__.py' ), '__version__ = "8.7.0"' ),
    ...
    'render_release_version' => false !== strpos( $render, 'SC_RL_RELEASE_VERSION' ) && false !== strpos( $render, '8.7.0' ),
