<?php
/** Static release contract checks for Research Librarian AI v6.6.1 compatibility regression. */
...
$checks = array(
    ...
    'bridge_version' => false !== strpos( $bridge, "const VERSION = '6.6.1';" ),
    'durable_module_version' => false !== strpos( $module, "const VERSION = '6.6.1';" ),
    'backend_version' => false !== strpos( file_get_contents( $root . '/backend/app/__init__.py' ), '__version__ = "6.6.1"' ),
    'sqlite_schema_seven' => false !== strpos( $store, 'SCHEMA_VERSION = 8' ),
    'index_schema_seven' => false !== strpos( $store, 'sc-research-librarian-knowledge-index/8.0' ),
    ...
    'route_note_handoff' => false !== strpos( $module, "'handoff_payload'" ) && false !== strpos( $module, 'sc-research-librarian-route-note/6.6.1' ),
    ...
    'render_release_version' => false !== strpos( $render, 'SC_RL_RELEASE_VERSION' ) && false !== strpos( $render, '6.6.1' ),
