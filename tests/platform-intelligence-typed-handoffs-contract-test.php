...
$checks = array(
    ...
    'bridge_version' => false !== strpos( $bridge, "const VERSION = '7.3.0';" ),
    'durable_module_version' => false !== strpos( $module, "const VERSION = '7.3.0';" ),
    'backend_version' => false !== strpos( file_get_contents( $root . '/backend/app/__init__.py' ), '__version__ = "7.3.0"' ),
    'sqlite_schema_seven' => false !== strpos( $store, 'SCHEMA_VERSION = 13' ),
    ...
    'workspace_schema' => false !== strpos( $backend, 'sc-research-librarian-public-workspace/2.2' ),
    ...
    'render_release_version' => false !== strpos( $render, 'SC_RL_RELEASE_VERSION' ) && false !== strpos( $render, '7.3.0' ),
