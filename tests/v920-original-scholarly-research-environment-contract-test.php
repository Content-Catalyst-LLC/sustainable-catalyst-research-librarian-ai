...
$required = [
  'plugin_version' => strpos($main, 'Version: 9.2.0') !== false,
  'backend_version' => strpos($backend, '__version__ = "9.2.0"') !== false,
...
echo "PASS: Research Librarian v9.2.0 Original Research & Scholarly Research Environment contract\n";
