...
$checks = array(
    ...
    'api_12' => false !== strpos( $platform, 'sc-connected-research-api/1.5' ),
    'workspace_22' => false !== strpos( $module, 'sc-research-librarian-public-workspace/2.5' ),
    ...
    'sqlite_schema_preserved' => false !== strpos( $store, 'SCHEMA_VERSION = 16' ),
);
