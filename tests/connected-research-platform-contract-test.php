...
$checks=array(
 ...
 'schema_ten'=>false!==strpos($store,'SCHEMA_VERSION = 19'),
 'index_ten'=>false!==strpos($store,'sc-research-librarian-knowledge-index/13.0'),
 ...
 'api_contract'=>false!==strpos($service,'sc-connected-research-api/2.0'),
 ...
 'workspace_two'=>false!==strpos($backend,'sc-research-librarian-public-workspace/3.0'),
 ...
 'manifest_version'=>is_array($manifest)&&'7.1.2'===($manifest['version']??''),
