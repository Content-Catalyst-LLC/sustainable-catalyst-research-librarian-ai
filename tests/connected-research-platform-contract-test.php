...
$checks=array(
 ...
 'schema_ten'=>false!==strpos($store,'SCHEMA_VERSION = 17'),
 ...
 'api_contract'=>false!==strpos($service,'sc-connected-research-api/1.6'),
 ...
 'workspace_two'=>false!==strpos($backend,'sc-research-librarian-public-workspace/2.6'),
