...
$checks = array(
    ...
    'workspace_data_version' => false !== strpos( $main, 'data-workspace-version="1.0"' ),
    ...
    'workspace_submit' => false !== strpos( $main, 'Build Research Workspace' ),
    'answer_first_intro' => false !== strpos( $main, 'presents a readable answer, evidence cards, a guided path, and controlled next actions' ),
    ...
    'workspace_schema' => false !== strpos( $backend, 'sc-research-librarian-public-workspace/1.0' ),
    ...
    'route_note_version' => false !== strpos( $module, 'sc-research-librarian-route-note/6.5.0' ),
