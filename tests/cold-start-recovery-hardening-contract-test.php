...
$checks = array(
    ...
    'schema_version_six_or_newer' => false !== strpos( $store, 'SCHEMA_VERSION = 19' ),
    ...
    'operations_export' => false !== strpos( $module, 'Export Diagnostics' ) && false !== strpos( $module, 'handle_log_export' ),
