<?php
/** Static release contract checks for Research Librarian AI v6.3.1. */
...
$checks = array(
    'version_header' => false !== strpos( $main, 'Version: 6.3.1' ),
    'version_constant' => false !== strpos( $main, "const VERSION        = '6.3.1';" ),
    'module_version' => false !== strpos( $module, "const VERSION = '6.3.1';" ),
    'backend_version' => false !== strpos( file_get_contents( $root . '/backend/app/__init__.py' ), '__version__ = "6.3.1"' ),
    'schema_version_four' => false !== strpos( $store, 'SCHEMA_VERSION = 4' ),
