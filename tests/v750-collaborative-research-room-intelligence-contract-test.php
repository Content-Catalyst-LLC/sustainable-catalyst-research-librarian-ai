...
$checks = array(
    ...
    'api_14' => false !== strpos( $platform, 'sc-connected-research-api/1.6' ),
    'workspace_24' => false !== strpos( $module, 'sc-research-librarian-public-workspace/2.6' ),
    'sqlite_schema_15' => false !== strpos( $store, 'SCHEMA_VERSION = 17' ),
