<?php
/** Static release contract for v7.0.6 asynchronous backend commit recovery. */
...
$checks = array(
    ...
    'durable_version' => false !== strpos( $module, "const VERSION = '7.0.6';" ),
    ...
    'background_task' => false !== strpos( $backend, 'background_tasks.add_task(store.commit_sync_job' ),
    ...
    'commit_worker_method' => false !== strpos( $store, 'def commit_sync_job' ),
    ...
    'admin_activated_records' => false !== strpos( $module, 'Activated records' ),
