<?php
/** Static contract checks for Research Librarian AI v6.2.0. */
$root = dirname( __DIR__ );
$main = file_get_contents( $root . '/sustainable-catalyst-research-librarian-ai.php' );
$module = file_get_contents( $root . '/includes/class-sc-rl-v620-knowledge-intelligence.php' );
...
$checks = array(
    'version' => false !== strpos( $main, "const VERSION        = '6.2.0';" ),
    'python_bridge_loaded' => false !== strpos( $main, 'class-sc-rl-v620-knowledge-intelligence.php' ),
    'backend_first_ask_path' => false !== strpos( $main, 'SC_RL6_V620_Knowledge_Intelligence::ask' ),
    ...
    'production_answer_ui' => false !== strpos( $js, 'sc-rl-production-answer' ) && false !== strpos( $css, 'v6.2.0 — Knowledge Library Intelligence and Production UX' ),
    ...
    'exact_title_priority' => false !== strpos( $retrieval, 'breakdown["exact_title"] = 420.0' ),
...
echo json_encode( array( 'version' => '6.2.0', 'checks' => $checks, 'failed' => $failed ), JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES ) . PHP_EOL;
