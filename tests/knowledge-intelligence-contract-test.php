<?php
/** Static contract checks for Research Librarian AI v6.4.1. */
...
$checks = array(
    'version' => false !== strpos( $main, "const VERSION        = '6.4.1';" ),
    ...
    'production_answer_ui' => false !== strpos( $js, 'sc-rl-production-answer' ) && false !== strpos( $css, 'v6.4.1 — Hybrid Retrieval, Durable Index, and Production UX' ),
...
echo json_encode( array( 'version' => '6.4.1', 'checks' => $checks, 'failed' => $failed ), JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES ) . PHP_EOL;
