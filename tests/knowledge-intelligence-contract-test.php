...
$checks = array(
    'version' => false !== strpos( $main, "const VERSION        = '10.0.0';" ),
...
echo json_encode( array( 'version' => '7.1.2', 'checks' => $checks, 'failed' => $failed ), JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES ) . PHP_EOL;
