...
$checks = array(
    'version' => false !== strpos( $main, "const VERSION        = '6.7.0';" ),
...
echo json_encode( array( 'version' => '6.7.0', 'checks' => $checks, 'failed' => $failed ), JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES ) . PHP_EOL;
