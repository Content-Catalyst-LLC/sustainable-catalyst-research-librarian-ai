...
$checks = array(
    'version' => false !== strpos( $main, "const VERSION        = '6.5.1';" ),
...
echo json_encode( array( 'version' => '6.5.1', 'checks' => $checks, 'failed' => $failed ), JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES ) . PHP_EOL;
