...
$checks = array(
    'version' => false !== strpos( $main, "const VERSION        = '7.0.8';" ),
...
echo json_encode( array( 'version' => '7.0.8', 'checks' => $checks, 'failed' => $failed ), JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES ) . PHP_EOL;
