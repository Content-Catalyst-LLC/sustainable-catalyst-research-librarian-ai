<?php
/** Static contract checks for Research Librarian AI v6.5.0. */
...
$checks = array(
    'version' => false !== strpos( $main, "const VERSION        = '6.5.0';" ),
...
echo json_encode( array( 'version' => '6.5.0', 'checks' => $checks, 'failed' => $failed ), JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES ) . PHP_EOL;
