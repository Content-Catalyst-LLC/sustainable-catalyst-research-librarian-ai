...
$checks = array(
    'plugin_version' => false !== strpos( $main, "const VERSION        = '6.7.0';" ),
...
$result = array( 'version' => '6.7.0', 'checks' => $checks, 'passed' => count( $checks ) - count( $failed ), 'failed' => count( $failed ), 'failures' => $failed );
