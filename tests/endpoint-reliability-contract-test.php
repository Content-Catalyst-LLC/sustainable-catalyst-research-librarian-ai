<?php
/** Static contract checks for Research Librarian AI v6.5.0 endpoint and recovery reliability. */
...
$checks = array(
    'plugin_version' => false !== strpos( $main, "const VERSION        = '6.5.0';" ),
...
$result = array( 'version' => '6.5.0', 'checks' => $checks, 'passed' => count( $checks ) - count( $failed ), 'failed' => count( $failed ), 'failures' => $failed );
