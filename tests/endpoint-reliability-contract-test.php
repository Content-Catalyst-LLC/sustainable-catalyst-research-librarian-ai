...
$checks = array(
    'plugin_version' => false !== strpos( $main, "const VERSION        = '8.11.0';" ),
...
$result = array( 'version' => '7.1.2', 'checks' => $checks, 'passed' => count( $checks ) - count( $failed ), 'failed' => count( $failed ), 'failures' => $failed );
