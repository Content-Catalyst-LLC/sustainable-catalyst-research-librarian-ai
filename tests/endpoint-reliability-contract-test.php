...
$checks = array(
    'plugin_version' => false !== strpos( $main, "const VERSION        = '7.0.6';" ),
...
$result = array( 'version' => '7.0.6', 'checks' => $checks, 'passed' => count( $checks ) - count( $failed ), 'failed' => count( $failed ), 'failures' => $failed );
