<?php
/** Static contract checks for Research Librarian AI v6.4.1 endpoint and recovery reliability. */
...
$checks = array(
    'plugin_version' => false !== strpos( $main, "const VERSION        = '6.4.1';" ),
...
$result = array( 'version' => '6.4.1', 'checks' => $checks, 'passed' => count( $checks ) - count( $failed ), 'failed' => count( $failed ), 'failures' => $failed );
