...
$checks = [
  'plugin_version' => strpos($main, 'Version: 9.3.0') !== false,
  'backend_version' => strpos($backend, '__version__ = "9.3.0"') !== false,
...
echo "PASS: Research Librarian v9.3.0 Peer Review, Replication & Scholarly Validation Environment contract\n";
