...
$checks=[
 'plugin_version'=>strpos($main,'Version: 9.7.0')!==false,
 'backend_version'=>strpos($backend,'__version__ = "9.7.0"')!==false,
...
echo "PASS: Research Librarian v9.7.0 Scholarly Publication, Citation & Research Dissemination Environment contract\n";
