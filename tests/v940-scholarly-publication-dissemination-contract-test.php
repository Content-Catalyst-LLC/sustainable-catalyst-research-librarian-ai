...
$checks=[
 'plugin_version'=>strpos($main,'Version: 10.1.0')!==false,
 'backend_version'=>strpos($backend,'__version__ = "10.1.0"')!==false,
...
echo "PASS: Research Librarian v10.1.0 Scholarly Publication, Citation & Research Dissemination Environment contract\n";
