...
$checks=[
 'plugin_version'=>strpos($main,'Version: 9.6.0')!==false,
 'backend_version'=>strpos($backend,'__version__ = "9.6.0"')!==false,
...
echo "PASS: Research Librarian v9.6.0 Scholarly Publication, Citation & Research Dissemination Environment contract\n";
