...
$checks = array(
    ...
    'persistent_state' => false !== strpos( $module, "sc_rl_v703_index_build_state" ) && false !== strpos( $module, "sc-rl-async-index-build/7.1.0" ),
    ...
    'transactional_batches' => false !== strpos( $module, 'wordpress-async-full-sync-v7.1.0' ) && false !== strpos( $module, '\'batch_count\' => $batch_count' ),
    ...
    'embedding_after_verify' => false !== strpos( $module, "'starting-embeddings'" ) && false !== strpos( $module, 'v7.1.0-async-index-build' ),
