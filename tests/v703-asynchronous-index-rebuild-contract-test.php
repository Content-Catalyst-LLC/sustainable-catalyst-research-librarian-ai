...
$checks = array(
    ...
    'version_constant' => false !== strpos( $module, "const VERSION = '7.1.2';" ),
    ...
    'transactional_batches' => false !== strpos( $module, 'wordpress-async-full-sync-v7.1.2' ) && false !== strpos( $module, '\'batch_count\' => $batch_count' ),
    ...
    'embedding_after_verify' => false !== strpos( $module, "'starting-embeddings'" ) && false !== strpos( $module, 'v7.1.2-async-index-build' ),
