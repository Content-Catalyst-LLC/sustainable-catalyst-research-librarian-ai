...
$checks = array(
    ...
    'schema_eight' => false !== strpos( $store, 'SCHEMA_VERSION = 11' ),
    'index_schema_eight' => false !== strpos( $store, 'sc-research-librarian-knowledge-index/11.0' ),
    ...
    'render_version' => false !== strpos( $render, '7.0.7' ),
