<?php
/** Static release contract checks for Research Librarian AI v6.6.1. */
...
$checks = array(
    ...
    'durable_version' => false !== strpos( $module, "const VERSION = '6.6.1';" ),
    'backend_version' => false !== strpos( file_get_contents( $root . '/backend/app/__init__.py' ), '__version__ = "6.6.1"' ),
    'schema_eight' => false !== strpos( $store, 'SCHEMA_VERSION = 8' ),
    'index_schema_eight' => false !== strpos( $store, 'sc-research-librarian-knowledge-index/8.0' ),
    ...
    'render_version' => false !== strpos( $render, '6.6.1' ),
