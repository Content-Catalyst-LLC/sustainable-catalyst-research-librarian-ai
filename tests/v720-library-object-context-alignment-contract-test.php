...
$checks = array(
    ...
    'sqlite_schema_13' => false !== strpos( $store, 'SCHEMA_VERSION = 15' ),
    ...
    'api_schema_11' => false !== strpos( $backend, 'sc-connected-research-api/1.4' ) || false !== strpos( file_get_contents( $root . '/backend/app/platform_v7.py' ), 'sc-connected-research-api/1.4' ),
    'workspace_schema_21' => false !== strpos( $backend, 'sc-research-librarian-public-workspace/2.4' ),
