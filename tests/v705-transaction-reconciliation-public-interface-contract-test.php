<?php
/** Static release contract for v7.1.2 transaction reconciliation and visible public controls. */
...
$checks = array(
    ...
    'durable_replay' => false !== strpos( $module, 'replaying all source batches as a fresh transaction' ),
    ...
    'visible_css_release' => false !== strpos( $css, 'v7.0.6 — visible research controls' ),
    ...
    'current_route_copy' => false !== strpos( $js, 'active v8.0.0 plugin' ),
