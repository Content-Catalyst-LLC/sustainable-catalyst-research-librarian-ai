<?php
/** Static release contract for v7.1.2 fail-closed Neon activation. */
...
$checks = array(
    ...
    'manifest' => is_array( $manifest ) && '7.1.2' === ( $manifest['version'] ?? '' ) && true === ( $manifest['database']['fail_closed'] ?? false ),
);
