<?php
/** Functional defaults and contract checks for v7.0.3. */
...
$passed='7.0.3'===$result['version']&&'public'===$result['mode']&&'private'===$result['visibility']&&'1'===$result['projects']&&'1'===$result['backup']&&'1'===$result['human_review'];
