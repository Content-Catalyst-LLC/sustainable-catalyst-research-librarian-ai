...
$passed='7.7.0' === $result['version']&&'public'===$result['mode']&&'private'===$result['visibility']&&'1'===$result['projects']&&'1'===$result['backup']&&'1'===$result['human_review']&&'1'===$result['library_object_model']&&'1'===$result['contextual_research']&&'1'===$result['personal_library_separation']&&'1'===$result['source_scope_provenance'];
