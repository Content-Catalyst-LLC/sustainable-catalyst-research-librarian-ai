...
$checks = array(
 'version' => false !== strpos($module, "const VERSION = '7.0.4'"),
 ...
 'admin_validation_metrics' => false !== strpos($module, 'Bytes processed'),
);
foreach ($checks as $name => $pass) { if (!$pass) { fwrite(STDERR, "FAIL: $name\n"); exit(1); } }
echo "v7.0.4 bounded finalization contract passed (" . count($checks) . " checks).\n";
