<?php
/**
 * Static regression checks for Research Librarian AI v6.2.0 Gemini auth-key support.
 */
$root = dirname( __DIR__ );
$main = file_get_contents( $root . '/sustainable-catalyst-research-librarian-ai.php' );
$admin = file_get_contents( $root . '/includes/class-sc-rl-v610-live-ai-admin.php' );
$checks = array(
    'version_header' => false !== strpos( $main, 'Version: 6.2.0' ),
    'version_constant' => false !== strpos( $main, "const VERSION        = '6.2.0';" ),
...
$result = array( 'version' => '6.2.0', 'checks' => $checks, 'failed' => $failed );
