...
$manifest=json_decode(file_get_contents($root.'/data/research_librarian_quality_governance_manifest_v7.0.7.json'),true);
$checks=array(
 ...
 'schema_nine'=>false!==strpos($store,'SCHEMA_VERSION = 11'),
 'index_nine'=>false!==strpos($store,'sc-research-librarian-knowledge-index/11.0'),
