<?php
/** Static release contract checks for Research Librarian AI v7.0.3. */
...
$manifest=json_decode(file_get_contents($root.'/data/research_librarian_quality_governance_manifest_v7.0.3.json'),true);
$checks=array(
 ...
 'manifest_version'=>is_array($manifest)&&'7.0.3'===($manifest['version']??''),
