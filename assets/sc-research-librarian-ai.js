(function () {
  ...
  function init(root) {
    ...
    function endpointFailureCopy(error) {
      ...
      if (statusCode === 404) {
        return { label: 'WordPress route unavailable', intro: 'The Research Librarian REST route was not found.', detail: 'Resave WordPress permalinks and confirm that the active v7.1.0 plugin registered its routes.' };
      }
      if (statusCode >= 500) {
